...
public interface SymbolTable {
	 ...
	 */
	boolean exists(String name, NamespaceInfo namespace, NamespaceInfoList usedns, SymbolInfo si);
   ...
   */
  SymbolInfo lookup(String name, NamespaceInfo namespace, NamespaceInfoList usedns, boolean local);
