...
public class ARMEngine extends AbstractMachine {
  ...
  public String generateAllVtables() throws MCSException {
    ...
    for (MethodInfo mi : VirtualTableCentral.instance().vtables().keySet()) {
      code += generateVtable(mi, VirtualTableCentral.instance().vtables().get(mi));
    }

    return code;
  }

  public String generateVtable(MethodInfo mi, VirtualTable vt) throws MCSException {
    String code =
